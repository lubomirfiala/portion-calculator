...
<template>
  <div class="food-card__header">
    ...
    />
    <AppButton tabindex="-1" @click="toggleMenu"><span class="mdi mdi-dots-horizontal" /></AppButton>
    <div v-if="menuOpen" class="dots-menu">
      <button class="dots-menu__item" @click="handleDelete">{{ t('delete') }}</button>
    </div>
    <AppButton tabindex="-1" @click="emit('toggle-collapse')">
